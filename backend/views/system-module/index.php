...
foreach ($models as $model) {
    ...
    echo '      <a id="add_fun_btn" href="index.php?r=system-function/index&id='.$model->id.'" class="btn btn-success btn-sm" href="#"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>添加功能</a>';
