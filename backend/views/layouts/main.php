				...
				<div class="nav-canvas">
					...
					<ul class="nav nav-pills nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="#"><i
								class="glyphicon glyphicon-home"></i>&nbsp;<span>默认</span></a>
						</li>
						<?php 
						...
						<li><a class="ajax-link" href="chart.html">
						<i class="glyphicon glyphicon-list-alt"></i><span> Charts</span></a>
						</li>
						...
						<li><a href="error.html"><i class="glyphicon glyphicon-ban-circle"></i><span>
